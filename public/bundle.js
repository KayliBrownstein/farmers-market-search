...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ResultsContainer = __webpack_require__(224);

	var _ResultsContainer2 = _interopRequireDefault(_ResultsContainer);

	var _MarketShowContainer = __webpack_require__(226);

	var _MarketShowContainer2 = _interopRequireDefault(_MarketShowContainer);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: '/:id', component: _MarketShowContainer2.default })
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ResultTile = __webpack_require__(225);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MarketShowTile = __webpack_require__(227);

	var _MarketShowTile2 = _interopRequireDefault(_MarketShowTile);
	...
	var MarketShowContainer = function (_Component) {
	  _inherits(MarketShowContainer, _Component);

	  function MarketShowContainer(props) {
	    _classCallCheck(this, MarketShowContainer);

	    var _this = _possibleConstructorReturn(this, (MarketShowContainer.__proto__ || Object.getPrototypeOf(MarketShowContainer)).call(this, props));
	  ...
	  _createClass(MarketShowContainer, [{
	    ...
	    value: function getMarketData() {
	      ...
	      var marketID = this.props.params.id;
	      fetch('http://search.ams.usda.gov/farmersmarkets/v1/data.svc/mktDetail?id=' + marketID).then(function (response) {
	        return response.json();
	      }).then(function (responseData) {
	        _this2.setState({ market: responseData.marketdetails });
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_MarketShowTile2.default, {
	  ...
	  return MarketShowContainer;
	}(_react.Component);

	exports.default = MarketShowContainer;
